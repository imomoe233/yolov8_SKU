...
model.train(data='D:\code\yolov8\cfg\\shouyin_candy_huojia.yaml',
            # pretrained=True,
...
model.train(data='D:\code\yolov8\cfg\\shouyin_candy_cengban.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
...
model.train(data='D:\code\yolov8\cfg\\shouyin_candy_shangpin.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
