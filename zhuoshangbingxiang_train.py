...
model.train(data='D:\code\yolov8\cfg\\zhuoshangbingxiang_huojia.yaml',
            # pretrained=True,
            ...
            name='zhuoshangbingxiang_huojia',
            save=True,
            save_period=5,
            val=True,
            split='val',
...
model.train(data='D:\code\yolov8\cfg\\zhuoshangbingxiang_cengban.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
...
model.train(data='D:\code\yolov8\cfg\\zhuoshangbingxiang_shangpin.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
            ...
            cos_lr=True,
            project='runs/OBB',
            name='zhuoshangbingxiang_shangpin',
            save=True,
            save_period=5,
            val=True,
            split='val',
