...
model.train(data='D:\code\yolov8\cfg\\candy_huojia.yaml',
            # pretrained=True,
...
model.train(data='D:\code\yolov8\cfg\\candy_cengban.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
...
model.train(data='D:\code\yolov8\cfg\\candy_shangpin.yaml',
            # pretrained=True,
            # model='D:\yolov8\guaTiao\\best.pt',
            cache=True,
            imgsz=640,
